...
<addon id="plugin.video.xbmctorrent" name="XBMCtorrent" version="0.6.4.014" provider-name="Heni, steeve">
    <requires>
...
Personnalisation basée sur XBMCTorrent 0.6.4 de Heni

To get the original latest updates:
