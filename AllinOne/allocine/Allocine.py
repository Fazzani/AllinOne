...
class Allocine(object):
    ...
    def _do_request(self, method=None, params=None):
        ...
        return simplejson.load(urllib2.urlopen(req, timeout = 10))
...
"""
    ...
    def movie(self, id, profile="small", mediafmt="mp4-lc:m"):
...
"""
    ...
    def tvseries(self, id, profile="small", mediafmt="mp4-lc:m"):
...
"""
    ...
    def season(self, id, profile="small"):
